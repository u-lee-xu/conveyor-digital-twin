...
import { MODBUS_READ_VARS, S7_VARS, MITSUBISHI_READ_VARS, MITSUBISHI_WRITE_VARS } from '../scenes/traffic-light/constants';

/**
 * 交通灯 IO 变量名 → 协议地址映射（随 connect 消息下发网关，
