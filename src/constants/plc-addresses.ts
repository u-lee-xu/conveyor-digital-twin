...
export const PLC_HELP_CONTENT: PLCHelpContent = {
  ...
  signals: {
    inputs: [
      ...
      },
      {
        ...
        address: 'M9',
        type: '输入',
        description: '检测物料颜色，蓝色物料时为 ON，黑色物料时为 OFF'
      },
      {
        name: '物料传感器',
        address: 'M10',
        type: '输入',
        description: '检测物料是否到达分拣位置'
      },
      {
        name: '停止按钮',
        address: 'M11',
  ...
  controlRequirements: [
    ...
    '物料随传送带运行至色标传感器位置，色标传感器检测物料颜色。',
    '若物料为蓝色（色标传感器 ON），物料到达物料传感器位置后，分拣1气缸推出将物料推入1号分拣口。',
    '若物料为黑色（色标传感器 OFF），物料到达物料传感器位置后，分拣2气缸推出将物料推入2号分拣口。',
